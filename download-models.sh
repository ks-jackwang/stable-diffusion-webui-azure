...
mv text_encoders/clip_g.safetensors clip/clip_g.safetensors
...
mv text_encoders/clip_l.safetensors clip/clip_l.safetensors
...
mv text_encoders/t5xxl_fp16.safetensors clip/t5xxl_fp16.safetensors
...
mv text_encoders/t5xxl_fp8_e4m3fn.safetensors clip/t5xxl_fp8_e4m3fn.safetensors
# [vae]
...
wget “https://civitai.com/api/download/models/914390?type=Model&format=SafeTensor&size=full&fp=fp16&token=$civitaitoken”
...
cd /github/ComfyUI/models/checkpoints
wget “https://civitai.com/api/download/models/290640?type=Model&format=SafeTensor&size=pruned&fp=fp16&token=$civitaitoken”

# [VAE] sdxl_vae.safetensors
cd /github/ComfyUI/models/vae
wget “https://civitai.com/api/download/models/290640?type=VAE&format=SafeTensor&size=pruned&fp=fp16&token=$civitaitoken”
...
cd /github/ComfyUI/models/checkpoints
wget “https://civitai.com/api/download/models/992946?type=Model&format=SafeTensor&size=full&fp=fp16&token=$civitaitoken”

## Pony Standard VAE V1.0  https://civitai.com/models/660673/pony-standard-vae
# [vae] ponyStandardVAE_v10.safetensors
cd /github/ComfyUI/models/vae
wget “https://civitai.com/api/download/models/785437?type=Model&format=SafeTensor&token=$civitaitoken”
...
wget “https://civitai.com/api/download/models/718487?type=Model&format=SafeTensor&token=$civitaitoken”
...
cd /github/ComfyUI/models/loras
wget “https://civitai.com/api/download/models/254162?type=Model&format=SafeTensor&token=$civitaitoken”
...
cd /github/ComfyUI/models/loras
wget “https://civitai.com/api/download/models/382152?type=Model&format=SafeTensor&token=$civitaitoken”

## Midjourney mimic v2.0 https://civitai.com/models/251417/midjourney-mimic?modelVersionId=678485
# [Lora] MJ52_v2.0.safetensors
cd /github/ComfyUI/models/loras
wget “https://civitai.com/api/download/models/678485?type=Model&token=$civitaitoken”
...
cd /github/ComfyUI/models/loras
wget “https://civitai.com/api/download/models/438481?type=Model&format=SafeTensor&token=$civitaitoken”
...
wget “https://civitai.com/api/download/models/775151?type=Model&format=SafeTensor&token=$civitaitoken”
...
cd /github/ComfyUI/models/embeddings
wget “https://civitai.com/api/download/models/772342?type=Negative&format=Other&token=$civitaitoken”
...
cd /github/ComfyUI/models/embeddings
wget “https://civitai.com/api/download/models/107234?type=Model&format=SafeTensor&token=$civitaitoken”

## 4x-Ultrasharp 4x-Ultrasharp v1.0 https://civitai.com/models/116225/4x-ultrasharp
cd /github/ComfyUI/models/upscale_models
wget “https://civitai.com/api/download/models/125843?type=Model&format=PickleTensor&token=$civitaitoken”
...
cd /github/ComfyUI/models/checkpoints
wget “https://civitai.com/api/download/models/1146884?type=Model&format=SafeTensor&size=full&fp=fp32&token=$civitaitoken”
...
cd /github/ComfyUI/models/checkpoints
wget “https://civitai.com/api/download/models/1146820?type=Model&format=SafeTensor&size=pruned&fp=fp16&token=$civitaitoken”
...
cd /github/ComfyUI/models/loras
wget “https://civitai.com/api/download/models/953083?type=Model&format=SafeTensor&token=$civitaitoken”
